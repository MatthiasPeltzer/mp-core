...
(
	...
	gallery_slider_type            tinytext,
	gallery_coverflow_rotate       int(11) unsigned DEFAULT '50'  NOT NULL,
	gallery_coverflow_stretch      int(11)          DEFAULT '0'  NOT NULL,
	gallery_coverflow_depth        int(11) unsigned DEFAULT '100' NOT NULL,
	gallery_coverflow_modifier     int(11) unsigned DEFAULT '1'  NOT NULL,
	gallery_fade_crossfade         tinyint(1)       DEFAULT '1'  NOT NULL,
	gallery_cube_shadow            tinyint(1)       DEFAULT '1'  NOT NULL,
	gallery_cube_slide_shadows     tinyint(1)       DEFAULT '1'  NOT NULL,
	gallery_keyboard_enabled       tinyint(1)       DEFAULT '1'  NOT NULL,
	gallery_autoplay_disable_on_interaction tinyint(1) DEFAULT '1' NOT NULL,
